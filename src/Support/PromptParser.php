...
final class PromptParser
{
     ...
     * @param array<string, mixed> $dynamicValues
     */
    ...
    ): string
    {
        ...
        foreach ($prompt->templateParts as $templatePart) {
            $renderedPrompt .= $this->renderTemplatePart($templatePart, $agentOutputs, $scope, $inputValues, $secretValues, $dynamicValues);
        }
     ...
     * @param array<string, mixed> $dynamicValues
     */
    private function renderTemplatePart(
        PromptTemplatePart $templatePart,
        array $agentOutputs,
        array $scope,
        array $inputValues,
        array $secretValues,
    ...
    ): string
    {
        ...
        $resolvedValue = $this->resolveReference($templatePart->expression->reference, $agentOutputs, $scope, $inputValues, $secretValues, $dynamicValues);
