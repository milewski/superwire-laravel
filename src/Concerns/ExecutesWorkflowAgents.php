...
{
    private function runAgent(Agent $agent, array $agentOutputs, array $dynamicValues): AgentExecutionResult
    {
        /**
        ...
        if (!$agent->runsForEach()) {
            ...
            $agentDynamicValues = $this->resolveDynamicValues($agent->dynamic, $agentOutputs, [], $dynamicValues);
         ...
         */
        $iterationValues = $this->resolveForEachValues($agent, $agentOutputs, $dynamicValues);
        ...
        foreach ($iterationValues as $iterationValue) {
            ...
            $iterationDynamicValues = $this->resolveDynamicValues($agent->dynamic, $agentOutputs, $scope, $dynamicValues);
            ...
            $prompt = $this->promptParser->render(
                ...
                inputValues: $this->inputValues,
                secretValues: $this->secretValues,
                dynamicValues: $iterationDynamicValues,
            );
    ...
    private function executeAgent(Agent $agent, string $prompt, array $outputSchema, array $agentOutputs, array $scope = [], array $dynamicValues = []): AgentExecutionResult
    {
        $toolset = AgentToolset::fromArray(
            tools: $this->resolveToolsForAgent($agent),
            outputSchema: $outputSchema,
            toolBindings: $this->resolveToolBindingsForAgent($agent, $agentOutputs, $scope, $dynamicValues),
